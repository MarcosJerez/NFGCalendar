...
<div id="sf_admin_container">
    ...
    <?php $ruta = (!isset($query_string) || $query_string == '')? '@sftGuardPlugin_cambiarPassword' : '@sftGuardPlugin_cambiarPasswordToken?'.$queryString ?>
    <form id="formCambioPassword" name="formCambioPassword" method="post" action="<?php echo url_for($ruta) ?>" >
