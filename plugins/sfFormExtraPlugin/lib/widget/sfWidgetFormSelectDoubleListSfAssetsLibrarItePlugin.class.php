 ...
 */
class sfWidgetFormSelectDoubleListSfAssetsLibrarItePlugin extends sfWidgetForm
{
  /**
   * Constructor.
   *
  ...
  $this->addOption('associated_choices', array());
    ...
    $this->addOption('unassociate', '<img src="'.public_path('/sfFormExtraPlugin/images/next.png').'" alt="unassociate" />');
    $this->addOption('associate', '<img src="'.public_path('/sfFormExtraPlugin/images/previous.png').'" alt="associate" />');
...
//-- Fin de los cambios
    ...
    $size = isset($attributes['size']) ? $attributes['size'] : (isset($this->attributes['size']) ? $this->attributes['size'] : 5);
  ...
  {
    return array(public_path('/sfFormExtraPlugin/js/double_list.js'));
  }
